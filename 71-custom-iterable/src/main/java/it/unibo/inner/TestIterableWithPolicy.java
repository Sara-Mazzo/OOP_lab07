...
public class TestIterableWithPolicy {
    ...
    private static <T> IterableWithPolicy<T> makeIterableWithPolicy(final T[] elements, final Predicate<T> filter) {
        IterableWithPolicyImpl<T> arrayIterabile = new IterableWithPolicyImpl<T>(elements, filter);
        return arrayIterabile; // TODO: return the implementation of IterableWithPolicy
    }

    private static <T> IterableWithPolicy<T> makeIterableWithPolicy(final T[] elements) {
        IterableWithPolicyImpl<T> arrayIterabile = new IterableWithPolicyImpl<T>(elements);
        return arrayIterabile; // TODO: return the implementation of IterableWithPolicy
    }
